...
class AuthRepo {
  ...
  Future<Response> signin(User user) async => await apiClient.postData(AppConstants.SIGN_UP,
        jsonEncode(user),
        null);
  ...
  Future<Response> getListUser(Pageable pageable) async{
    Map<String, String> header = {
      "pageIndex": pageable.pageIndex.toString(),
      "size": pageable.size.toString(),
    };
    return await apiClient.getData(AppConstants.GET_USERS, headers: header);
  }
